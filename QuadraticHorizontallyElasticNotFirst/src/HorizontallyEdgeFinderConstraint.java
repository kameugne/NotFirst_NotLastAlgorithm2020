 ...
 *
 **/
public class HorizontallyEdgeFinderConstraint extends AdjustmentsPropagator {
    ...
    public HorizontallyEdgeFinderConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do
        {
            ...
            HorizontallyEdgeFinder ef = new HorizontallyEdgeFinder(tasks, capacity);
            HorizontallyEdgeFinder ef_negative = new HorizontallyEdgeFinder(negativeTasks, capacity);
