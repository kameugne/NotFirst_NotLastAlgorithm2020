 ...
 */
/*
    This implementation is the relaxed quadratic horizontally elastic not-first/not-last algorithm proposed in the paper
    It is denoted QRHE-NF in the paper.
 */
public class HorizontallyNotFirstConstraint extends AdjustmentsPropagator {
    ...
    public HorizontallyNotFirstConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
