 ...
 *
 **/
public class HorizontallyEdgeFinderRevisitedConstraint extends AdjustmentsPropagator {
    ...
    public HorizontallyEdgeFinderRevisitedConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do
        {
            ...
            HorizontallyEdgeFinderRevisited ef = new HorizontallyEdgeFinderRevisited(tasks, capacity);
            HorizontallyEdgeFinderRevisited ef_negative = new HorizontallyEdgeFinderRevisited(negativeTasks, capacity);

            //Tentative ef = new Tentative(tasks, capacity);
            //Tentative ef_negative = new Tentative(negativeTasks, capacity);
